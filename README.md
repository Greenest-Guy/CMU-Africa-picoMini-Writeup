...
Detailed write-up of my solutions for the [CMU Africa picoMini](https://play.picoctf.org/practice?originalEvent=77&page=1) competition. Each challenge contains the challenge setup, the steps to solve it, along with the tools, commands, or scripts used!
